...
class pix2equation(BasicModel):
    def __init__(self, input_shape, output_size, output_dir, strategy):
        ...
        print('Intializing pix2equation')
        ...
        with strategy.scope():
            ...
            # Set the initial learning rate and scale it by the number of devices
            initial_learning_rate = 0.0001
            scaled_learning_rate = initial_learning_rate * num_devices
            optimizer = RMSprop(learning_rate=scaled_learning_rate, clipvalue=1.0)
            self.model.compile(loss='categorical_crossentropy', optimizer=optimizer)
    def fit(self, dist_dataset, batch_size, steps_per_epoch, valid_generator, validation_steps, checkpoint):
        self.model.fit(dist_dataset, 
